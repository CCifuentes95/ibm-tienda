...
public class EmpresaView implements Serializable {
    ...
    public void listener_txtId() {
        try {
            ...
            entity = (id != null) ? businessDelegatorView.getEmpresa(id) : null;
        } catch (Exception e) {
            entity = null;
        }

        if (entity == null) {
            txtContacto.setDisabled(false);
            ...
            txtContacto.setValue(entity.getContacto());
            txtContacto.setDisabled(false);
    ...
    public String action_edit(ActionEvent evt) {
        selectedEmpresa = (EmpresaDTO) (evt.getComponent().getAttributes()
                                           .get("selectedEmpresa"));
        txtContacto.setValue(selectedEmpresa.getContacto());
        txtContacto.setDisabled(false);
        txtDescripcion.setValue(selectedEmpresa.getDescripcion());
        txtDescripcion.setDisabled(false);
        txtImagen.setValue(selectedEmpresa.getImagen());
        txtImagen.setDisabled(false);
        txtNombre.setValue(selectedEmpresa.getNombre());
        txtNombre.setDisabled(false);
        txtId.setValue(selectedEmpresa.getId());
        txtId.setDisabled(true);
        btnSave.setDisabled(false);
        setShowDialog(true);
    ...
    public String action_create() {
        try {
            ...
            entity.setContacto(FacesUtils.checkString(txtContacto));
    ...
    public String action_modify() {
        try {
            if (entity == null) {
                Long id = new Long(selectedEmpresa.getId());
                entity = businessDelegatorView.getEmpresa(id);
            }
    ...
    public String action_modifyWitDTO(String contacto, String descripcion,
        Long id, String imagen, String nombre) throws Exception {
        try {
            entity.setContacto(FacesUtils.checkString(contacto));
    ...
    public InputText getTxtContacto() {
        return txtContacto;
    }

    public void setTxtContacto(InputText txtContacto) {
