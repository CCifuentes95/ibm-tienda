...
public class TipoProductoLogic implements ITipoProductoLogic {
    ...
    */
    ...
    public void validateTipoProducto(TipoProducto tipoProducto)
        throws Exception {
        try {
            Set<ConstraintViolation<TipoProducto>> constraintViolations = validator.validate(tipoProducto);

            if (constraintViolations.size() > 0) {
                StringBuilder strMessage = new StringBuilder();

                for (ConstraintViolation<TipoProducto> constraintViolation : constraintViolations) {
    ...
    public void saveTipoProducto(TipoProducto entity) throws Exception {
        ...
        try {
            ...
            validateTipoProducto(entity);

//            if (getTipoProducto(entity.getId()) != null) {
...
//            }
    ...
    public void deleteTipoProducto(TipoProducto entity)
        ...
        try {
            productos = productoDAO.findByProperty("tipoProducto.id",
                    entity.getId());
            ...
            tipoProductoDAO.deleteById(entity.getId());
    ...
    public List<TipoProductoDTO> getDataTipoProducto()
        ...
        try {
            ...
            for (TipoProducto tipoProductoTmp : tipoProducto) {
                TipoProductoDTO tipoProductoDTO2 = tipoProductoMapper.tipoProductoToTipoProductoDTO(tipoProductoTmp);
    ...
    public TipoProducto getTipoProducto(Long id) throws Exception {
        ...
        try {
            entity = tipoProductoDAO.findById(id);
        } catch (Exception e) {
