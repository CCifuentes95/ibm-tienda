...
//            if (getTipoIdentificacion(entity.getId()) != null) {
...
//            }
    ...
    public void deleteTipoIdentificacion(TipoIdentificacion entity)
        ...
        try {
            usuarios = usuarioDAO.findByProperty("tipoIdentificacion.id",
                    entity.getId());
            ...
            tipoIdentificacionDAO.deleteById(entity.getId());
    ...
    public TipoIdentificacion getTipoIdentificacion(Long id)
        ...
        try {
            entity = tipoIdentificacionDAO.findById(id);
        } catch (Exception e) {
