...
public class EmpresaLogic implements IEmpresaLogic {
    private static final Logger log = LoggerFactory.getLogger(EmpresaLogic.class);
    ...
    */
    ...
    public List<Empresa> getEmpresa() throws Exception {
        ...
        try {
            ...
            log.error("finding all Empresa failed", e);
    ...
    public void saveEmpresa(Empresa entity) throws Exception {
        ...
        try {
            ...
            validateEmpresa(entity);

//            if (getEmpresa(entity.getId()) != null) {
//                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
//            }

            empresaDAO.save(entity);
            log.debug("save Empresa successful");
        } catch (Exception e) {
    ...
    public void deleteEmpresa(Empresa entity) throws Exception {
        ...
        try {
            inventarios = inventarioDAO.findByProperty("empresa.id",
                    entity.getId());

            if (Utilities.validationsList(inventarios) == true) {
                throw new ZMessManager().new DeletingException("inventarios");
            }

            empresaDAO.deleteById(entity.getId());
    ...
    public void updateEmpresa(Empresa entity) throws Exception {
        ...
        try {
            ...
            log.debug("update Empresa successful");
        } catch (Exception e) {
    ...
    public List<EmpresaDTO> getDataEmpresa() throws Exception {
        try {
            ...
            for (Empresa empresaTmp : empresa) {
                EmpresaDTO empresaDTO2 = empresaMapper.empresaToEmpresaDTO(empresaTmp);
    ...
    public Empresa getEmpresa(Long id) throws Exception {
        ...
        try {
            entity = empresaDAO.findById(id);
        } catch (Exception e) {
            log.error("get Empresa failed", e);
