...
import com.ibm.tienda.utilities.Constantes;
...
//            }
    ...
    public void deleteUsuario(Usuario entity) throws Exception {
        ...
        try {
            pedidos = pedidoDAO.findByProperty("usuario.id", entity.getId());
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
	...
	/** 
	 * (non-Javadoc)
	 * @see com.ibm.tienda.modelo.control.IUsuarioLogic#getUsuarioByIdentificacion(java.lang.String)
	 */
	@Override
    @Transactional(readOnly = true)
	public Usuario getUsuarioByIdentificacion(String identificacion) throws Exception {
		log.info("Entró en getUsuarioByIdentificacion");
		...
		try {
        	...
        	log.error("Hubo un error en getUsuarioByIdentificacion: "+e.getMessage() , e);
            throw e;
        } 
	}
	...
	/** 
	 * (non-Javadoc)
	 * @see com.ibm.tienda.modelo.control.IUsuarioLogic#getUsuarioDTOByIdentificacion(java.lang.String)
	 */
	@Override
    @Transactional(readOnly = true)
	public UsuarioDTO getUsuarioDTOByIdentificacion(String identificacion) throws Exception {
		try {
			Usuario usuario = getUsuarioByIdentificacion(identificacion);
